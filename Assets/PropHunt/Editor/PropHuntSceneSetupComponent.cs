...
namespace PropHunt.Editor
{
    ...
    /// NO MENU ITEMS - Just attach this component to any GameObject
    ///
    /// HOW TO USE:
    /// 1. Create an empty GameObject in your scene (or use existing one)
    /// 2. Add Component → PropHuntSceneSetupComponent
    /// 3. Configure settings in Inspector
    /// 4. Click "Setup Scene" button
    /// 5. Delete this GameObject when done
    /// </summary>
    public class PropHuntSceneSetupComponent : MonoBehaviour
    {
        ...
        // This just prevents errors in play mode
        private void Start()
        {
            Debug.LogWarning("[PropHunt Setup] This is an editor-only component. Delete this GameObject after setup.");
        }
    }

    [CustomEditor(typeof(PropHuntSceneSetupComponent))]
    public class PropHuntSceneSetupComponentEditor : UnityEditor.Editor
    {
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.HelpBox(
                "This wizard will create all PropHunt GameObjects in your scene.\n\n" +
                ...
                "💡 You can delete this GameObject after setup is complete.",
                MessageType.Info);

            EditorGUILayout.Space();

            PropHuntSceneSetupComponent wizard = (PropHuntSceneSetupComponent)target;
            ...
            if (GUILayout.Button("Delete This Setup Component", GUILayout.Height(25)))
            {
                if (EditorUtility.DisplayDialog("Delete Setup Component",
                    "Delete this GameObject? The setup will remain in the scene.",
                    "Yes, Delete", "Cancel"))
                {
                    DestroyImmediate(wizard.gameObject);
                }
            }
            GUI.backgroundColor = Color.white;
        }

        private void SetupScene(PropHuntSceneSetupComponent wizard)
        {
        ...
        private void CreateSpawnPoints(PropHuntSceneSetupComponent wizard, Transform parent)
        {
            // Lobby Spawn
        ...
        private void CreateLobbyArea(PropHuntSceneSetupComponent wizard, Transform parent)
        {
        ...
        private void CreateArenaArea(PropHuntSceneSetupComponent wizard, Transform parent)
        {
        ...
        private void CreateZoneVolumes(PropHuntSceneSetupComponent wizard, Transform parent)
        {
        ...
        private void CreateZone(PropHuntSceneSetupComponent wizard, Transform parent, string zoneName,
        ...
        private void CreateSampleProps(PropHuntSceneSetupComponent wizard, Transform parent)
        {
        ...
        private void ShowCompletionDialog()
        {
            EditorUtility.DisplayDialog("Setup Complete! ✅",
                ...
                "💡 You can now delete the Setup GameObject\n\n" +
                "Then hit Play!",
                "Got It!");
        }
